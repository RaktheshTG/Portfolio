export default function About() {
  return (
      <section id="about" className="about section-pad">
        ...
        <div className="github-graph-wrap" data-reveal>
          <span className="github-graph-label">GitHub Activity</span>
          <div className="github-graph-image-wrap">
            <img
              src="https://ghchart.rshah.org/7c3aed/RaktheshTG"
